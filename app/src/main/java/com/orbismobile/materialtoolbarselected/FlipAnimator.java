...
public class FlipAnimator {
     ...
     */
    public static void flipView(Context context, final View unchecked, final View checked, boolean showFront) {
...
//        }
        ...
        leftIn.setTarget(unchecked);
        rightOut.setTarget(checked);
        showFrontAnim.playTogether(leftIn, rightOut);
        showFrontAnim.setDuration(3000);
        showFrontAnim.start();
